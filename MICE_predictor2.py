...
HDLC = st.number_input("高密度脂蛋白胆固醇 (HDL-C, mmol/L):", min_value=0.0, max_value=10.0, value=1.2, step=0.1, format="%.1f")

# LDLC: numerical input
LDLC = st.number_input("低密度脂蛋白胆固醇 (LDL-C, mmol/L):", min_value=0.0, max_value=20.0, value=3.0, step=0.1, format="%.1f")
